...
ADD https://checker-mainet-s3.s3.ap-southeast-1.amazonaws.com/eu/AethirCheckerCLI-linux-1.0.2.6.tar.gz /opt/aethir
RUN tar -zvxf /opt/aethir/AethirCheckerCLI-linux-1.0.2.6.tar.gz -C /opt/aethir/ --strip-components 1
